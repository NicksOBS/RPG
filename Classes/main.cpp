...
int main() {
    ...
    jogador.set_jogador_dinheiro(100);
    ...
    try {
        ...
        cout << "2. Guerreiro: Um remanescente de ordens caidas, empunhando laminas enferrujadas e a forca bruta de um passado glorioso." << endl << endl;
        ...
        switch (escolha_classe) {
            case 1: {
                ...
                cout << " Que as nevoas do arcano o(a) guiem, " << nome << "." << endl << endl;
                break;
            }
            case 2: {       
                jogador.set_jogador_classe(*guerreiro);      
                cout << "-Voce escolheu ser um guerreiro!" << endl;
                cout << " Que a sua lamina nunca falhe,  " << nome << "." << endl << endl;
                break;
            }
            default:
        ...
        if(explorar_dungeon_facil(jogador, dungeon)){
            ...
            cout << "Voce decide retornar rapidamente para a cidade, para em seguida, ajudar a sonhera." << endl;
            cidade(jogador, mercado);
            DungeonNormal dungeon2;
            passou = explorar_dungeon_normal(jogador, dungeon2);
        }
        if(passou){
            cout << ">Ao derrotar o cavaleiro corrompido em uma batalha voraz, voce consegue livrar cavaleiro heroi da vila da sua maldicao." << endl;
            ...
            cout << "Antes de seguinte para a dungeon mais profunda, onde o lorde das sombras esta escondido, voce resolve retornar para a cidade, a fim de recuperar suas forcas." << endl;
            cidade(jogador, mercado);
